package DP系列.博弈型DP.Nim游戏;import java.util.Scanner;
/**
 * @Author: Jack
 ...
 * 推理：
 * 让我们考虑一些小例子。显而易见的是，如果石头堆中只有一块、两块、或是三块石头，那么在你的回合，
 * 你就可以把全部石子拿走，取胜从而在游戏中。而如果就像题目描述那样，堆中恰好有四块石头，你就会失败。
 ...
 * 你就不可避免地会输掉，因为不管你从一堆石头中挑出一块、两块还是三块，你的对手都可以选择三块、两块或一块，
